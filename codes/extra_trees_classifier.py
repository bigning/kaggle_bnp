...
X_test = test
print('Training...')
extc = ExtraTreesClassifier(n_estimators=opt.n_estimators,max_features= 60,criterion= 'entropy',min_samples_split= 4,max_depth= opt.max_depth, min_samples_leaf= 2, n_jobs = -1, verbose = 2)
